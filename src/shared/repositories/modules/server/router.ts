import ErrorInterface from "../../../types/error/error";
import AutheticatedUserInterface from "../../../types/response/authencated-user";
import AuthorizationRepo, { TokenType } from "../encryption";
...
class RequestHandler {
    ...
    private host: string
    private authenticationRepo: AuthorizationRepo;
    private endPointList: { endpoint: string, method: string, middleWares: string }[] = []
    private tokenType: TokenType

    constructor({router, authenticationRepo, host, tokenType} : { router: any, authenticationRepo: AuthorizationRepo, host: string, tokenType?: TokenType}) {
